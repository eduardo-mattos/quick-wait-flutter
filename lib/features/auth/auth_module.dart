...
import 'package:quick_wait_android/features/auth/domain/usecases/login_use_cases.dart';
import 'package:quick_wait_android/features/auth/presentation/pages/home_page.dart';

class AuthModule extends Module {
  @override
  List<Bind<Object>> get binds => [Bind.lazySingleton <AuthRepository> ((i) => AuthRepositoryImpl()), 
